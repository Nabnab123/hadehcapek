                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $sql=$koneksi->query("SELECT pd.kode_penjualan, jumlah, brg.* FROM tb_penjualan_detail pd JOIN tb_barang brg ON pd.kode_barcode = brg.kode_barcode WHERE pd.kode_penjualan ='$kode'");
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo "Rp. ".number_format ($data['harga_jual']) * $data['jumlah']."000"?></td>
                                    ...
                                    <tr>
                                        <th colspan="5" style="text-align: center;">Jumlah Keuntungan</th>
