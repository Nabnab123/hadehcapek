...
$query = "SELECT kode_barcode FROM tb_barang ORDER BY kode_barcode DESC";
$result = mysqli_query($koneksi,$query);
$row = mysqli_fetch_array($result);
$lastid = $row['kode_barcode'];
if(empty($lastid))
{
    $number = "BR001";
}
					...
					<div class="body">
                        <form method="POST">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="kode_barcode" class="form-control" value="<?php echo $number; ?>" readonly style=" font-size: 14px; color: blue; font-weight: bold; " />
                                </div>
                            </div>
